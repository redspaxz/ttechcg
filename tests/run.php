...
$assert(str_contains($adminDashboard->body(), '<span>Unpaid balance</span><strong class="pickup-kpi-amount">0</strong><small>XAF open in the last 3 months</small>'), 'The dashboard KPI should show unpaid balance for the last three months instead of duplicating total recorded cash.');
