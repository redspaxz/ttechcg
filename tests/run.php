...
$assert(str_contains($adminDashboard->body(), '<span>Unpaid balance</span><strong>0</strong><small>XAF open in the last 3 months</small>'), 'The dashboard should render unpaid balance as a KPI card.');
