...
$assert(!str_contains($adminDashboard->body(), '<span>Unpaid balance</span><strong class="pickup-kpi-amount">'), 'The dashboard should not render unpaid balance as a KPI card.');
