...
(async () => {
    ...
    assert.match(fetchRequest.url, /submissions\/page\?page=2&per_page=10$/);
    ...
    assert.match(pushedUrl, /submissions\?page=2&per_page=10$/);
    ...
    assert.match(fetchRequest.url, /submissions\/page\?q=controller&page=1&per_page=10$/);
    ...
    assert.match(fetchRequest.url, /submissions\/page\?(?:page=1&per_page=10|per_page=10&page=1)$/);
