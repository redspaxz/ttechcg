...
$router->post('/pickupsheet/submissions/login', fn (Request $request): Response => $pickupsheetController->login($request));
$router->post('/pickupsheet/submissions/logout', fn (Request $request): Response => $pickupsheetController->logout($request));
