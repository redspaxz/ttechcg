...
<head>
    ...
    <link rel="stylesheet" href="<?= $e($assetBase) ?>/styles.css?v=20260831-consignor-autocomplete">
    <script src="<?= $e($assetBase) ?>/app.js?v=20260831-consignor-autocomplete" defer></script>
