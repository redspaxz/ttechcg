...
<head>
    ...
    <link rel="stylesheet" href="<?= $e($assetBase) ?>/styles.css?v=20260831-managed-user-disable">
    <script src="<?= $e($assetBase) ?>/app.js?v=20260831-managed-user-disable" defer></script>
