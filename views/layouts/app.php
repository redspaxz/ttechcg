...
<head>
    ...
    <link rel="stylesheet" href="<?= $e($assetBase) ?>/styles.css?v=20260831-autocomplete-progressive">
    <script src="<?= $e($assetBase) ?>/app.js?v=20260831-autocomplete-progressive" defer></script>
