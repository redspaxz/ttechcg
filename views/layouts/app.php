...
<head>
    ...
    <link rel="stylesheet" href="<?= $e($assetBase) ?>/styles.css?v=20260824-technology-partners">
    <script src="<?= $e($assetBase) ?>/app.js?v=20260824-technology-partners" defer></script>
</head>
<body>
