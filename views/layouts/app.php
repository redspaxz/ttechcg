...
<head>
    ...
    <link rel="stylesheet" href="<?= $e($assetBase) ?>/styles.css?v=20260909-dashboard-card-padding">
    <script src="<?= $e($assetBase) ?>/app.js?v=20260909-audit-log-accordion" defer></script>
