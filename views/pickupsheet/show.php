    ...
    <div class="container pickup-form-shell">
        ...
        <form class="pickup-form" method="post" action="<?= $e($basePath) ?>/dhl/pickupsheet" data-pickup-form>
            ...
            <section class="shipment-editor" aria-labelledby="shipment-editor-title">
                ...
                <p class="shipment-editor-note" id="consignor-suggestion-help">Start typing the beginning of a consignor name. Existing matches prioritize exact, frequent, and recent senders; you can still enter a new name.</p>
                <p class="shipment-editor-note">Time collected is recorded automatically when this pickup sheet is submitted.</p>
