...
<section class="pickup-admin-workspace">
    ...
    <div class="container pickup-admin-shell pickup-dashboard-shell">
        ...
        <section class="pickup-kpi-grid" aria-label="Pickupsheet KPIs">
            ...
            <article><span>Unpaid balance</span><strong class="pickup-kpi-amount"><?= $e(number_format((int) ($summary['unpaidBalanceXaf'] ?? 0))) ?></strong><small>XAF open in the last 3 months</small></article>
        </section>
