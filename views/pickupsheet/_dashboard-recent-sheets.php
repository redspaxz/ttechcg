...
<div class="pickup-dashboard-table-wrap">
    ...
    <?php foreach ($items as $sheet): ?>
        <tr>
            ...
            <td><?= $e($sheet->shipmentCount()) ?></td>
            <td><?= $e(number_format($sheet->totalCashReceivedXaf)) ?> XAF</td>
            <td><a href="<?= $e($basePath) ?>/dhl/pickupsheet/submissions?reference=<?= $e(rawurlencode($sheet->referenceNumber)) ?>">Records</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody></table>
</div>
