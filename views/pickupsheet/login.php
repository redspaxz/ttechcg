    ...
    <div class="pickup-login-panel">
        ...
        <?php if (($jumpCloudEnabled ?? false) === true): ?>
            <div class="pickup-sso-login">
                ...
                <small>Your JumpCloud name and approved group determine your account identity and role.</small>
            </div>
        <?php endif; ?>

        <?php if (($jumpCloudEnabled ?? false) === true): ?><div class="pickup-login-divider"><span>Or sign in with a local account</span></div><?php endif; ?>
